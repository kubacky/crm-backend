 ...
 */
$config['tables']['users'] = 'crm_users';
$config['tables']['groups'] = 'crm_users_groups';
$config['tables']['users_groups'] = 'crm_users_grouped';
$config['tables']['login_attempts'] = 'crm_login_attempts';
 ...
 */
$config['site_title'] = "Platforma 2.0";       // Site Title, example.com
$config['admin_email'] = "kubacki.artur@gmail.com"; // Admin Email, admin@example.com
